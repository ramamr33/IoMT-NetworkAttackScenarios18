...
# File names
files = {
    "NORMAL": "flowmonitor-stats_wip.xml",
    "DOS": "flowmonitor-stats_dos.xml",
    "DDOS": "flowmonitor-stats_ddos.xml",
    "MITM": "flowmonitor-stats_mitm.xml",
    "BLACKHOLE": "flowmonitor-stats_black.xml",
}
...
final_df.to_csv("flow_level_results.csv", index=False)
print("Flow-level results saved to flow_level_results.csv")
