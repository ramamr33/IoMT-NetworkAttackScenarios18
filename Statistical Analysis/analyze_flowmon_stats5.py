...
def extract_metrics_from_xml(xml_file):
    ...
    for i, flow in enumerate(flows):
        ...
        required_keys = ['txBytes', 'rxBytes', 'delaySum', 'jitterSum',
...
# Filter scenarios and metric groups with enough variance and samples
...
# ANOVA and Tukey HSD results containers
anova_results = {}
tukey_rows = []

for metric in metrics:
    # Filter scenarios that have at least 2 samples and std dev > 0
    filtered_scenarios = []
