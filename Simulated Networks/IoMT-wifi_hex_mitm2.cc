...
int main(int argc, char *argv[]) {
    ...
    ApplicationContainer baxterTrafficApp = baxterTraffic.Install(wifiNodes.Get(2));
    ...
    // NetAnim
    AnimationInterface anim("network-anim_mitm_hexoskin.xml");
    ...
    monitor->SerializeToXmlFile("flowmonitor-stats_mitm_hexoskin.xml", true, true);
