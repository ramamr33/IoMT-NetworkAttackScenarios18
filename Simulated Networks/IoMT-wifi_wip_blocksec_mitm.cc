...
int main(int argc, char *argv[]) {
   ...
   Blockchain blockchain;
    ...
    phy.EnablePcap("hexoskin_blocksec_mitm", staDevices.Get(1));
    phy.EnablePcap("hexoskin_phone_blocksec_mitm", staDevices.Get(2));
    phy.EnablePcap("mitm_blocksec_mitm", mitmDevice);

    // NetAnim
    AnimationInterface anim("network-anim_blocksec_mitm.xml");
    ...
    monitor->SerializeToXmlFile("flowmonitor-stats_blocksec_mitm.xml", true, true);
