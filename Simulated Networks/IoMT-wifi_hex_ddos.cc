...
int main(int argc, char *argv[]) {
    ...
    Ptr<Node> targetNode = hexoskinNodes.Get(0);   // Target node is now Hexoskin Shirt
    Ipv4Address targetAddress = p2pInterfaces.GetAddress(1);  // Get Hexoskin node's IP address
